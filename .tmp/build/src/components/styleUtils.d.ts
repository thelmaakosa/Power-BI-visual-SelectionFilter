...
export declare const genFontStyleObj: (fontBold?: boolean | string, fontColor?: string, fontFamily?: string, fontItalic?: boolean, fontSize?: number, fontUnderline?: boolean, position?: string, stepIndentation?: number, wordWrap?: boolean) => {
    font: string;
...
export declare const genBorderStyleObj: (outlineTop?: boolean, outlineRight?: boolean, outlineBottom?: boolean, outlineLeft?: boolean, outlineRadiusTopLeft?: number, outlineRadiusTopRight?: number, outlineRadiusBottomRight?: number, outlineRadiusBottomLeft?: number, outlineColor?: string, outlineThickness?: number) => {
    borderWidth: string;
    borderRadius: string;
    borderColor: string;
    borderStyle: string;
