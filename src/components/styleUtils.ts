...
export const genFontStyleObj = (
  ...
  const obj = {
    ...
    textIndent: `${stepIndentation}px`,
    color: `${fontColor}`,
    wordWrap: `${wordWrap ? "break-word" : "normal"}` as any,
  };
  return obj
};


export const genBorderStyleObj = (
  outlineTop = true,
  outlineRight = true,
  outlineBottom = true,
  outlineLeft = true,
  ...
  const obj = {
    borderWidth: `${outlineTop ? outlineThickness : 0}px ${
      outlineRight ? outlineThickness : 0
    }px ${outlineBottom ? outlineThickness : 0}px ${
      outlineLeft ? outlineThickness : 0
    }px`,
    borderRadius: `${outlineRadiusTopLeft}px ${outlineRadiusTopRight}px ${outlineRadiusBottomRight}px ${outlineRadiusBottomLeft}px`,
    borderColor: `${outlineColor}`,
    borderStyle: `${outlineTop ? "solid" : "none"} ${
      outlineRight ? "solid" : "none"
    } ${outlineBottom ? "solid" : "none"} ${outlineLeft ? "solid" : "none"}`,
  };
  return obj;
